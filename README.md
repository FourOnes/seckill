this is an demo app about deadline in e-commerce system, app fetch the product data from remote server, user can operation until reached to the deadline.
